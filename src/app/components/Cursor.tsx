...
export default function CustomCursor() {
  ...
  const cursorVariants = {
    default: { scale: 1, height: 64, width: 64 },
    hovered: { scale: 1.5 },
    clicked: { scale: 0.75 },
  };
  ...
  return (
    ...
    >
      <div className="w-full h-full cursor-none bg-[#4D2101] opacity-[98%] rounded-full blur-[1px] border-[2px] border-[#4D2101]">
        <img src="/cursor.png" alt="" style={{ maxWidth: "100%", maxHeight: "100%" }} className="hidden md:block rotate-12" />
      </div>
    </motion.div>
  );
}
